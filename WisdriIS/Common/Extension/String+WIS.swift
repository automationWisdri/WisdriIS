...
extension String {
    ...
    var wis_removeAllNewLines: String {
...
extension String {
    ...
    func wis_rangeFromNSRange(nsRange: NSRange) -> Range<Index>? {
    ...
    func wis_NSRangeFromRange(range: Range<Index>) -> NSRange {
...
extension String {
    ...
    func wis_mentionWordInIndex(index: Int) -> (wordString: String, mentionWordRange: Range<Index>)? {
        ...
        guard let range = self.wis_rangeFromNSRange(nsRange) else {
            return nil
        }
...
extension String {
    ...
    var wis_firstImageURL: NSURL? {

        let URLs = wis_embeddedURLs
