...
//        NSNotificationCenter.defaultCenter().addObserver(self, selector: "syncFriendships:", name: FriendsInContactsViewController.Notification.NewFriends, object: nil)
        ...
        if tableRowCount > Ruler.iPhoneVertical(6, 8, 10, 12).value {
...
//    }
    ...
    func tableView(tableView: UITableView, willDisplayCell cell: UITableViewCell, forRowAtIndexPath indexPath: NSIndexPath) {
        ...
        cell.avatarImageView.image = UIImage(named: "default_avatar_40")
        cell.joinedDateLabel.text = "维修工程师"
        cell.lastTimeSeenLabel.text = "在线"
        cell.nameLabel.text = "任韬"
...
//
            performSegueWithIdentifier("showShift", sender: nil)
//        }
   }
}
