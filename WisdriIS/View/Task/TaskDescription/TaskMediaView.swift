//
//  TaskDescriptionMediaView.swift
//  WisdriIS
//
...
class TaskMediaView: UIView {
    ...
    func setImagesWithFileInfo(file: [WISFileInfo]) {
...
/*
        ...
        case 1:
            ...
            if let thumbnailImage = attachments[0].thumbnailImage {
                ...
                imageView1.yep_setImageOfAttachment(file[0], withSize: fullRect.size)
            }
        ...
        case 2:
            ...
            if let thumbnailImage = attachments[0].thumbnailImage {
                ...
                imageView1.yep_setImageOfAttachment(file[0], withSize: halfRect.size)
            }
            ...
            if let thumbnailImage = attachments[1].thumbnailImage {
                ...
                imageView2.yep_setImageOfAttachment(file[1], withSize: halfRect.size)
            }
        ...
        case 3:
            ...
            if let thumbnailImage = attachments[0].thumbnailImage {
                ...
                imageView1.yep_setImageOfAttachment(file[0], withSize: quarterRect.size)
            }
            ...
            if let thumbnailImage = attachments[1].thumbnailImage {
                ...
                imageView2.yep_setImageOfAttachment(file[1], withSize: quarterRect.size)
            }
            ...
            if let thumbnailImage = attachments[2].thumbnailImage {
                ...
                imageView3.yep_setImageOfAttachment(file[2], withSize: halfRect.size)
            }
        ...
        case 4..<Int.max:
            ...
            if let thumbnailImage = attachments[2].thumbnailImage {
                ...
                imageView3.yep_setImageOfAttachment(file[2], withSize: quarterRect.size)
            }
            ...
            if let thumbnailImage = attachments[3].thumbnailImage {
                ...
                imageView4.yep_setImageOfAttachment(file[3], withSize: quarterRect.size)
            }
