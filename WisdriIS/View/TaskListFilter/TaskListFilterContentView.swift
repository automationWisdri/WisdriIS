...
class TaskListFilterContentView: UIView {
    ...
    init(frame: CGRect, parentViewController: UIViewController!, initialGroupSelection: TaskListGroupType) {
        ...
        self.taskListFilterWrapperView.backgroundColor = UIColor.wisBorderColor()
        self.taskListFilterWrapperView.contentSize = CGSize(width: refFrame.width, height: contentHeight)
        ...
        if self.taskListFilterButtonView == nil {
            ...
            self.taskListFilterButtonView = UIView(frame: CGRectMake(buttonViewX, buttonViewY, contentWrapperFrame.size.width, taskListFilterButtonViewHeight))
        }
        ...
        self.backgroundColor = UIColor.wisBorderColor()
    ...
    func buttonPressed(sender: UIButton) {
        ...
        switch buttonType {
        case .OK:
            self.delegate?.taskListFilterContentViewConfirmed(TaskListGroupType(rawValue: self.taskListFilterGroupContentView.currentSelectedIndexPath.row)!)
